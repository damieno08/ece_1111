// file: /data/courses/ece_1111/2025_01_fall/labs/lab_11/ortiz_damien/p01/p01.cc/
//
...
// Program will sort a numerical file
// in compared order
//
...
int main(int argc, char** argv){  
  ...
  if(argc == 3){
    ...
    //
    signed long* ints = getIntegers(fileName, numLines);
    if(!ints)
      return 1;

    // sort the array of all integers
    //
    qsort(ints, numLines, sizeof(signed long), compare);
  ...
  fprintf(stdout, "Usage: p01.exe <input_file> <output_file>\n");
